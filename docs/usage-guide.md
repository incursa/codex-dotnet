...
- [`CodexThreadEvent`](../src/Incursa.OpenAI.Codex/ConversationTypes.cs) and [`CodexThreadItem`](../src/Incursa.OpenAI.Codex/ConversationTypes.cs) hierarchies for streamed runtime data, including [`CodexTurnPlanUpdatedEvent`](../src/Incursa.OpenAI.Codex/ConversationTypes.cs), [`CodexPlanDeltaEvent`](../src/Incursa.OpenAI.Codex/ConversationTypes.cs), and [`CodexAccountRateLimitsUpdatedEvent`](../src/Incursa.OpenAI.Codex/ConversationTypes.cs) for pushed plan and rate-limit changes
