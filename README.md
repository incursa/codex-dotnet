...
- [`CodexTurn`](src/Incursa.OpenAI.Codex/CodexClient.cs): single-turn handle with `StreamAsync`, `StreamNormalizedAsync`, `RunAsync`, `RunToResultAsync`, `SteerAsync`, and `InterruptAsync`
